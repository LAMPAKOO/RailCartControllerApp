...
def setup_system_column(ui, parent_layout):
    ...
    ui.btn_m1 = QtWidgets.QPushButton("M1"); ui.btn_m2 = QtWidgets.QPushButton("M2")
    ui.btn_m3 = QtWidgets.QPushButton("M3"); ui.btn_m4 = QtWidgets.QPushButton("M4")
    ...
    col3_layout.addWidget(lbl_title_conn)
    
    conn_layout = QtWidgets.QHBoxLayout()
    ui.port_combo = QtWidgets.QComboBox()
    ui.port_combo.setFixedHeight(60)
    ui.port_combo.setStyleSheet("QComboBox { background-color: #333333; color: white; font-size: 20px; font-weight: bold; border: 1px solid #444; border-radius: 5px; padding-left: 10px; } QComboBox::drop-down { border: none; }")
    
    ui.btn_refresh = QtWidgets.QPushButton("🔄")
    ui.btn_refresh.setFixedSize(60, 60)
    ui.btn_refresh.setStyleSheet("QPushButton { background-color: #444444; color: white; font-size: 26px; border-radius: 5px; } QPushButton:hover { background-color: #555555; }")
    ...
    ui.btn_connect.setStyleSheet("QPushButton { background-color: #444444; color: white; font-size: 20px; font-weight: bold; border-radius: 5px; } QPushButton:hover { background-color: #555555; }")
    ui.btn_connect.clicked.connect(ui.toggle_connection)
    
    conn_layout.addWidget(ui.port_combo); conn_layout.addWidget(ui.btn_refresh); conn_layout.addWidget(ui.btn_connect)
